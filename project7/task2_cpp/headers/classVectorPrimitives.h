...
//#include "extraBusPrimitives.h"		// it was the initial code from the Professor --> included its content directly
	void resize(int i, char c) { v.assign(i, c); }
	void assign(char* c) { v.assign(c);	}
};
